...
func (r *Repository) AddDoctor(userData model.User, doctorData model.DoctorAdditionalData) error {
	tx, err := r.db.Begin()
	if err != nil {
		return err
	}
...
func (r *Repository) GetDoctor(ID uuid.UUID) (model.User, model.DoctorAdditionalData, error) {
	tx, err := r.db.Begin()
	if err != nil {
